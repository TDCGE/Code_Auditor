...
3. **Language/framework**: JS/TS, Python, Go, etc.? Suggest if the user is unsure. Base your recommendations on the required features and ecosystem best practices.
